...
<g:textField name="TEMPORARY" value = "TEMP" id="LOCX">SSSSS</g:textField>
<g:textField name="TEMPORARY" value = "TEMP" id="LOCY">SSSSS</g:textField>
    <!-- Placed at the end of the document so the pages load faster -->
    <script src="js/jquery.js"></script>
    <script src="js/bootstrap.min.js"></script>
    <script src="js/functions.js"></script>
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDYYlVAfK-Y4up3d__e3XcVItoE6J6ABf8&sensor=true"></script>
