        ...
        render: function(){
            ...
            */
            ...
            if(this.state.coords.length < 2){
                csMap = React.createElement(CSMap, {handleMapClick: this.handleMapClick})
            }
            else{
                csMap = React.createElement(CSMap, {coords: this.state.coords, zoom: 12, handleMapClick: this.handleMapClick})
            }
            return (
